...
// import
// com.commigo.metaclass.MetaClass.gestionestimaduratameeting.adapter.StimaDurataMeetingAdapterImpl;
...
public class GestioneStimaMeetingServiceImpl implements GestioneStimaMeetingService {
   ...
   */
  @Override
  public Double getDurataMeeting(Long id_stanza)
      throws RuntimeException403, ServerRuntimeException {
  ...
  private Double requestPrediction(Utente utente) {
    ...
    // conversione sesso
    int sex;
    if (utente.getSesso().equalsIgnoreCase("M")) sex = 2;
    else if (utente.getSesso().equalsIgnoreCase("F")) sex = 1;
    else sex = 0;
