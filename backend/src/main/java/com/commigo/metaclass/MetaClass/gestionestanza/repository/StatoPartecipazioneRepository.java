...
public interface StatoPartecipazioneRepository extends JpaRepository<StatoPartecipazione, Long> {
    ...
    /**
     * meotodo che permette di ricercare tutti gli stati parteciapzione riferiti ad una determinata stanza
    ...
    /**
     * metodo che permette di ricercare tutti gli utenti in attessa all'interno di una determinata stanza
     * @param id id della stanza su cui si basa la ricerca
