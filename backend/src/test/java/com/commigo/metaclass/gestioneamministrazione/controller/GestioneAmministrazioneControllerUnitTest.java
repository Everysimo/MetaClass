...
import com.commigo.metaclass.gestionestanza.service.GestioneStanzaServiceImpl;
...
@ContextConfiguration(
    classes = {
      GestioneAmministrazioneController.class,
...
class GestioneAmministrazioneControllerUnitTest {
   ...
   */
  @MockBean private GestioneAmministrazioneService amministrazioneService;

  @MockBean private GestioneStanzaService gestioneStanzaService;
  @MockBean private ValidationToken validationToken;
  @MockBean private JwtTokenUtil jwtTokenUtil;
  @InjectMocks private GestioneAmministrazioneController amministrazioneController;
  ...
  private void sendRequestServerFailureScenario(Scenario scenario) throws Exception {
    ...
    try {
      ...
      MvcResult result =
          MockMvcBuilders.standaloneSetup(amministrazioneController)
              .build()
              .perform(requestBuilder)
              .andReturn();
  ...
  /**
   * testing creazione scenario per ogni test case vado a richiamare un metodo che mi valida degli
   * scenari volontariamente errati per testare i messaggi di errori che vengono ritornati
